...
// Only run generator logic if the generator elements exist on this page
// (they only exist on index.html — every other page would crash without this check)
if (generateBtn) {
...
} // end of "if (generateBtn)" check

// Auto-fill the footer copyright year (runs on every page)
